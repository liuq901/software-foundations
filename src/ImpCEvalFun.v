...
Definition peven : com :=
  ...
  END;;
  IFB BEq (AId X) (ANum 0) THEN Z ::= ANum 0 ELSE Z ::= ANum 1 FI.
(** [] *)
...
(** Write an informal proof of [ceval_step__ceval], following the
  ...
  [ceval_step] returns [Some st'] iff the program terminated on state [st'].
  This is the same meaning of [c / st || st'].
[]
*)
