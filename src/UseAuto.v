...
Proof. 
  introv E1 E2.
  gen st2.
  ceval_cases (induction E1) Case; introv E2; inverts E2; auto.
  Case "E_Seq".
    apply IHE1_1 in H1.
    subst.
    auto.
...
Theorem preservation' : forall t t' T,
  ...
  has_type empty t' T.
Proof.
  introv E1 E2; remember \empty as Gamma; gen t'.
  induction E1; introv HE; inverts* HE; subst*.
  apply* substitution_preserves_typing; inverts* E1_1.
Qed.
...
Proof.
  ...
  destruct* IHHt1.
  destruct* IHHt2.
  inverts* H; inverts* Ht1.
  destruct* IHHt1.
  destruct* t1; inverts* H.
  inverts* Ht1.
Qed.
...
Proof.
  introv Hnorm; induction Hnorm; intros; subst.
  apply* E_Const.
  apply* step__eval.
Qed.
...
Theorem multistep__eval' : forall t v,
  normal_form_of t v -> exists n, v = C n /\ t || n.
Proof.
  introv Hnorm; inverts Hnorm; rewrite nf_same_as_value in H0; inverts H0.
...
Proof.
  ...
  lets (U1&U2&H3&H4&H5): sub_inversion_arrow H1.
  inverts* H3.
Qed.
...
Proof.
  ...
  unfold extend in Hctx; cases_if'*; inverts Hctx.
  apply* context_invariance; introv Hcontra.
  lets* [T' HT']: free_in_context S empty Hcontra; inverts HT'.
  ...
  introv Hafi; unfold extend; cases_if'*. 
  apply IHt; apply* context_invariance.
