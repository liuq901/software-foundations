...
(** Try answering the following questions on paper and
    ...
    Eval compute in (combine [1;2] [false;false;true;true]) = [(1,false);(2,false)]
*)
...
(** For example, [X] is [nat] and [Y] is [option nat]. **)
...
(** 
    ...
    - Next, suppose [l = x :: l'], where
        index (pred n) l' = None
      We must show
        index n l = None
      By the definition of [index], this follows from
        index n l = index (pred n) l'
