...
Inductive substi (s:tm) (x:id) : tm -> tm -> Prop := 
  ...
  | s_abs2 : forall y T t t',
      x <> y -> substi s x t t' -> substi s x (tabs y T t) (tabs y T t')
...
Proof.
  ...
  Case "<-".
    t_cases (induction t) SCase; intros; simpl;
      inversion H; subst; clear H;
      try rewrite eq_id;
      try rewrite neq_id;
      try apply IHt in H5;
      try (apply IHt1 in H2; apply IHt2 in H4);
      try (apply IHt1 in H3; apply IHt2 in H5; apply IHt3 in H6);
      subst; auto.
Qed.
(** [] *)
...
Proof.
  ...
  induction T11; intros; inversion H0.
  apply IHT11_1.
  rewrite H2.
  apply H1.
Qed.
